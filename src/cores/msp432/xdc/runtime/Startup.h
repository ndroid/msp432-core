...
typedef struct { int length; xdc_runtime_Startup_InitFxn const *elem; } __ARRAY1_xdc_runtime_Startup_firstFxns;
...
typedef struct { int length; xdc_runtime_Startup_InitFxn const *elem; } __ARRAY1_xdc_runtime_Startup_lastFxns;
...
#endif
/*
 *  @(#) xdc.runtime; 2, 1, 0,0; 5-10-2017 08:13:21; /db/ztree/library/trees/xdc/xdc-D13/src/packages/
 */
